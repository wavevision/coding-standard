...
```xml
<rule ref="vendor/wavevision/coding-standard/WavevisionCodingStandard"/>
```

or use directly

```bash
vendor/bin/phpcs -p --standard=vendor/wavevision/coding-standard/WavevisionCodingStandard <pathToSources>
```
